...
Optimierte traditionelle Spritesheet-Verarbeitung ohne ComfyUI-Abhängigkeiten
"""
...
class StandaloneEnhancedSpritesheetProcessor:
    """Enhanced Traditional Spritesheet Processing - Standalone Version"""
    ...
    def process_spritesheet_enhanced(self, image_path: Path, adaptive_tolerance=True, tolerance_override=30.0,
        ...
        bg_colors, detected_tolerance = self.enhanced_background_detection(
            image_bgr, multi_zone_sampling, hsv_analysis
        )
        ...
        foreground_mask = self.create_enhanced_mask(
            image_bgr, bg_colors, final_tolerance, hsv_analysis,
            morphological_cleanup, edge_refinement
        )

        # Enhanced Frame Extraction
        extracted_frames = self.extract_frames_enhanced(
            image_bgr, foreground_mask, aggressive_extraction, min_area_factor
        )
        ...
        return processed_frames, processing_info, frame_stats
